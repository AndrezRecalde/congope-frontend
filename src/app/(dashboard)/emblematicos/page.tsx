...
import { EmblematicoTable }    from
  '@/components/modulos/emblematicos/EmblematicoTable';
import { EmblematicosFiltros } from
  '@/components/modulos/emblematicos/EmblematicoFiltros';
...
export default function EmblematicoPage() {
  const [filtros, setFiltros] =
    useState<EmblematicoFiltros>(FILTROS_INICIALES);
  ...
  const {
    mutateAsync: crearEmblematicoAsync,
  } = useCrearEmblematico();
  const {
    mutateAsync: actualizarEmblematicoAsync,
  } = useActualizarEmblematico();
