...
import {
  SimpleGrid, Button, Skeleton,
  Stack, Pagination, Center, Group,
} from '@mantine/core';
...
import { PracticaCard }     from
  '@/components/modulos/practicas/PracticaCard';
import { PracticasFiltros } from
  '@/components/modulos/practicas/PracticasFiltros';
...
export default function BuenasPracticasPage() {
  const [filtros, setFiltros] =
    useState<PracticaFiltros>(FILTROS_INICIALES);
  const [destacandoId, setDestacandoId] =
  ...
  const handleExportar = async () => {
    try {
      ...
      notifications.show({
        ...
        message: 'El módulo de exportación de buenas ' +
