...
import type { EntidadDocumento } from "@/types/documento.types";
...
export default function DocumentosPage() {
  const [filtro, setFiltro] = useState<DocumentoFiltro>(FILTRO_INICIAL);
  ...
  const abrirModalSubir = () => {
    modals.open({
      ...
      children: (
        <SubirDocumentoForm
          entidad_tipo={filtro.entidad_tipo as EntidadDocumento}
  ...
  const handlePublicar = (doc: DocumentoItem) => {
    ...
    publicarDoc(
      { id: doc.id, es_publico: !doc.es_publico },
      {
  ...
  const hayEntidadSeleccionada = !!filtro.entidad_tipo && !!filtro.entidad_id;
    ...
    <Box pos="relative" mih="100%">
      ...
      {!hayEntidadSeleccionada ? (
        ...
        <Center py="3xl">
          <Stack align="center" gap="md" maw={400}>
            ...
            <Text size="sm" c="dimmed" ta="center">
              Selecciona el tipo de entidad y la entidad específica para ver sus
        ...
        <Alert
          ...
          radius="md"
        >
          Ocurrió un error al consultar los documentos de esta entidad. El
          backend puede estar procesando la solicitud. Intenta nuevamente en
          unos momentos.
        </Alert>
