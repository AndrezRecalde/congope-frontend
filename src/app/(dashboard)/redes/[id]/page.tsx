...
import { MiembrosPanel } from "@/components/modulos/redes/MiembrosPanel";
...
function EditarRedModal({ red, id }: { red: Red; id: string }) {
  ...
  return (
    <RedForm
      red={red}
      onSubmit={(datos) =>
        actualizarRed({ id, datos }, { onSuccess: () => modals.closeAll() })
      }
...
export default function RedDetallePage(props: PageProps) {
  ...
  const { data: red, isLoading, isError } = useRed(id);
          ...
          <Stack gap="md">
            ...
            >
              <Group justify="space-between" mb="md">
                ...
                <Group gap="xs">
                  <Badge color={COLOR_TIPO_RED[red.tipo]} variant="light">
                    {red.tipo}
                  </Badge>
                  <Badge
            ...
            >
              <MiembrosPanel redId={id} miembros={red.miembros} />
            </Paper>
          </Stack>
        </Grid.Col>
          ...
          <Stack gap="md">
            ...
            >
              ...
              <Stack gap="md">
                <Group justify="space-between">
                  ...
                  <Badge size="lg" variant="light" color="congope">
                    {red.miembros.length}
                  </Badge>
                </Group>
                ...
                {red.miembros.length > 0 && (
                  <>
                    ...
                    <Stack gap="xs">
                      ...
                      {Object.entries(
                        red.miembros.reduce<Record<string, number>>(
                          (acc, m) => {
                            acc[m.actor.tipo] = (acc[m.actor.tipo] ?? 0) + 1;
                            return acc;
                          },
                          {},
                        ),
            ...
            >
              ...
              <Text size="xs" c="dimmed">
                Los documentos asociados a esta red se gestionan desde el módulo
                de Documentos.
