...
import type { ActorCooperacion, CreateActorDto } from "@/services/axios";
...
export function ActorForm({
  ...
  const handleSubmit = (values: ActorFormValues) => {
    ...
    const dto: CreateActorDto = {
      ...
      areas_tematicas:
        values.areas_tematicas.length > 0 ? values.areas_tematicas : undefined,
    };
    onSubmit(dto);
  };
      ...
      <form onSubmit={form.onSubmit(handleSubmit)}>
        <Stack gap="md">
          ...
          <FileInput
            ...
            placeholder={
              esEdicion && actor?.logo
                ? "Subir nuevo logo para reemplazar el actual"
