...
import {
  ...
  Button, Group, Checkbox, Divider, Text, Box, LoadingOverlay,
} from '@mantine/core';
  ...
  useEffect(() => {
    if (esEdicion && practicaDetalle) {
      form.setValues({
        ...
        es_destacada:         practicaDetalle.es_destacada === true || String(practicaDetalle.es_destacada) === '1' || String(practicaDetalle.es_destacada).toLowerCase() === 'true',
      });
    }
        ...
        */}
        ...
        <Group justify="flex-end" gap="sm" pt="xs">
          <Button variant="subtle" color="gray"
            onClick={onCancel} disabled={isSubmitting || cargandoDetalle}>
            Cancelar
          </Button>
          <Button type="submit" color="congope"
            loading={isSubmitting} disabled={cargandoDetalle}>
