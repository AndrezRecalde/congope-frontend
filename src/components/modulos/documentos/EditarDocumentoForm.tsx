...
import {
  Stack, TextInput, Select, Switch,
  Group, Button, Box, LoadingOverlay,
} from '@mantine/core';
...
import type { EditarDocumentoValues }
  from '@/types/documento.types';
import type { EditarDocumentoDto }
