...
import type { SubirDocumentoValues } from "@/types/documento.types";
import type { SubirDocumentoDto } from "@/services/documentos.service";
            ...
            {archivo ? (
              ...
              >
                ...
                >
                  ...
                  <Dropzone.Reject>
                    <IconX size={36} color="var(--mantine-color-red-6)" />
                  </Dropzone.Reject>
                  <Dropzone.Idle>
                    <IconFile size={36} color="var(--mantine-color-gray-5)" />
                  </Dropzone.Idle>
