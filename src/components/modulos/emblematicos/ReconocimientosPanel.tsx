...
import { IconPlus, IconEdit, IconTrash, IconTrophy } from "@tabler/icons-react";
...
export function ReconocimientosPanel({
  ...
  const { mutateAsync: crearReconocimientoAsync } =
    useCrearReconocimiento(emblematicoId);

  const { mutateAsync: actualizarReconocimientoAsync } =
                  ...
                  <Stack gap={4} style={{ minWidth: 0 }}>
                    ...
                    <Group gap="xs" wrap="wrap">
                      ...
                      <Badge
                        ...
                        variant="light"
                        color={
                          rec.ambito === "Internacional" ? "violet" : "blue"
                        }
                      >
                        {rec.ambito}
                      </Badge>
                    ...
                    <Text size="xs" c="dimmed">
                      Registrado: {formatFecha(rec.created_at)}
                    </Text>
                  </Stack>
                </Group>
