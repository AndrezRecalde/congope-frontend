        ...
        {!hayFiltros && (
          <div style={{
            ...
            <p style={{
              ...
              Aplica un filtro en el mapa para ver
              los proyectos emblemáticos de cada territorio
            </p>
          </div>
        )}
          ...
          cargando ? (
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: 15 }}>
                No hay proyectos emblemáticos en
                este territorio
              </p>
            </div>
          ) : (
