...
import type { EstadisticasPortal } from "@/services/portal.service";
import {
  IconCoinFilled,
  IconMapPinFilled,
...
export function PortalEstadisticas({ estadisticas }: PortalEstadisticasProps) {
  ...
  const optionOds = {
    tooltip: {
      ...
      textStyle: { color: "white", fontSize: 12, fontFamily: "DM Sans" },
    ...
    yAxis: {
      type: "category",
      data: odsOrdenados.map((o) => `ODS ${o.numero} — ${o.nombre}`).reverse(),
      axisLabel: {
  ...
  return (
    <section id="estadisticas" className="portal-stats-section">
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          ...
          >
            Impacto real de la cooperación internacional en los Gobiernos
          ...
          {kpiItems.map((item, i) => (
            ...
            >
              <div style={{ fontSize: 32, marginBottom: 8 }}>
                <item.icono size={42} color={item.color} stroke={1.5} />
              </div>
              <div
                style={{
                  fontFamily: "var(--font-playfair)",
                  fontSize: typeof item.valor === "string" ? 20 : 36,
                  fontWeight: 700,
                  color: "white",
                  lineHeight: 1.1,
                  marginBottom: 4,
        ...
        >
          ...
          >
            ...
            <ReactECharts
              option={optionOds}
              style={{
                height: Math.max(por_ods.length * 36 + 20, 200),
              }}
