...
import type { BuenaPracticaPortal } from "@/services/portal.service";
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            <div>
              ...
              >
                Experiencias replicables destacadas por los GAD Provinciales
              </p>
            </div>
        ...
        {!hayFiltros && (
          ...
          >
            <div style={{ fontSize: 40, marginBottom: 12 }}>
              <IconBulbFilled size={40} color="var(--portal-gold)" />
            </div>
            <p
              style={{
                fontFamily: "var(--font-playfair)",
            ...
            >
              Filtra por provincia o actor para explorar las experiencias de
              cada territorio
            </p>
          </div>
        )}
          ...
          (cargando ? (
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: 15 }}>
                No hay buenas prácticas destacadas en este territorio
              </p>
            </div>
          ) : (
            <div
            ...
            >
              {practicas.map((p) => {
                ...
                return (
                  <div key={p.id} className="portal-practica-card">
                      ...
                      <div className="portal-estrellas">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <span
                            ...
                            style={{
                              fontSize: 12,
                              opacity: i <= Math.round(calif) ? 1 : 0.25,
                            }}
                          >
                            ★
                          </span>
