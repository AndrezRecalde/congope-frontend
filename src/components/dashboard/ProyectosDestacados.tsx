...
export function ProyectosDestacados() {
  ...
  const proyectos =
    data?.proyectos_destacados ?? data?.kpis?.proyectos_destacados ?? [];
      ...
      >
        <Group gap="xs" c="dimmed">
          ...
          <Text size="sm" ta="center">
            Todavía no hay proyectos en ejecución para mostrar.
          </Text>
        </Group>
      </Paper>
    );
        ...
        columns={[
          ...
          },
          {
            ...
            render: (p) => {
              ...
              const provinciasConAvance = provincias.filter(
                (prov) =>
                  prov.porcentaje_avance !== null &&
                  prov.porcentaje_avance !== undefined,
              );
              ...
              if (avancePromedio === undefined) {
                return (
                  <Group gap="xs" align="center" wrap="nowrap">
                    ...
                    />
                    <Text size="xs" c="dimmed" fw={600} miw={36}>
                      {p.avance || 0}%
                    </Text>
                  </Group>
                );
              ...
              return (
                ...
                >
                  <Group
                    ...
                    style={{
                      cursor:
                        provinciasConAvance.length > 1 ? "help" : "default",
                    }}
                  >
                    <Progress
                      value={avancePromedio}
                      size="sm"
                      color={avancePromedio === 100 ? "green" : "blue"}
                      style={{ flex: 1, minWidth: 60 }}
                    />
                    <Text size="xs" c="dimmed" fw={600} miw={36}>
                      {avancePromedio}%
          ...
          },
          {
            ...
            render: (p) => (
              <Text size="sm" fw={600}>
                $
                {parseFloat(p.inversion || "0").toLocaleString("en-US", {
